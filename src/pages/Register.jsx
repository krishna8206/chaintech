  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 sm:p-8 bg-rose-50 text-slate-800 selection:bg-rose-200 selection:text-rose-900">
      <div className="w-full max-w-md bg-white p-8 sm:p-10 rounded-3xl shadow-[0_8px_30px_rgb(225,29,72,0.1)] border border-rose-50 relative overflow-hidden">
        <div className="absolute -bottom-20 -left-20 w-48 h-48 bg-rose-100 rounded-full mix-blend-multiply filter blur-3xl opacity-50 animate-pulse"></div>
        <div className="mb-8 text-center relative z-10">
          ...
          <h2 className="text-2xl font-black text-rose-900 tracking-tight">Create an account</h2>
          <p className="text-rose-500 mt-2 font-bold text-sm">Join LuxeCommerce today. It's free!</p>
        </div>
        ...
        <p className="mt-8 text-center text-sm font-bold text-slate-500 relative z-10">
          ...
          <Link to="/login" className="font-black text-rose-500 hover:text-rose-600 hover:underline hover:underline-offset-4 transition-all">
            Sign in
          </Link>
        </p>
      </div>
